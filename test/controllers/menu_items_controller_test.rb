...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { description: @menu_item.description, image_url: @menu_item.image_url, name: @menu_item.name, price: @menu_item.price, section: @menu_item.section } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { description: @menu_item.description, image_url: @menu_item.image_url, name: @menu_item.name, price: @menu_item.price, section: @menu_item.section } }
